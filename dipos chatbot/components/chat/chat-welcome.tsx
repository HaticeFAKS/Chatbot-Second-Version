...
export function ChatWelcome({ onSuggestionClick }: ChatWelcomeProps) {
  const suggestions = [
    {
      icon: HelpCircle,
      text: "onaylı projede poliçeyi nasıl yenileyebilirim?",
      category: "product",
    },
    {
      icon: HelpCircle,
      text: "yedek cihaz kullanılamaz hatasını nasıl düzeltebilirim?",
      category: "product",
    },
    {
      icon: HelpCircle,
      text: "web service processing error hatasının sebebi ne?",
      category: "product",
    },
    {
      icon: AlertCircle,
      text: "kurulum linklerine ulaşamıyorum",
      category: "product",
    },
  ]
